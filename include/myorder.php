...
try {
    ...
    $rows = $mng->executeQuery("PerfectPlate.orders", $order);
...
?>
    <section class="confirmation_part" style="padding-bottom: 30px;">
        <div class="container">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6"><br />
                                            ...
                                            <h6 style="color: gray;"><?php echo $row->First_Name; ?></h6>
                                            <h6 style="color: gray;"><?php echo $row->Phone; ?></h6>
                                            <h6 style="color: gray;">₹ <?php echo $row->Total_Amount; ?></h6>
                                            <h6 style="color: gray;"><?php echo $row->Payment_Mode; ?></h6><br />
                                        </div>
                                    </div>
                                    <h5 class="card-header">Shipping Address</h5><br />
                                    <div class="row">
                                        <div class="col-6">
                                            <h6>Address:</h6>
                                            <h6>Country:</h6>
                                        ...
                                        <div class="col-6">
                                            <h6 style="color: gray;"><?php echo $row->Address_Line1; ?></h6>
                                            <h6 style="color: gray;"><?php echo $row->Country; ?></h6>
                                            <h6 style="color: gray;"><?php echo $row->City; ?></h6>
                                            <h6 style="color: gray;"><?php echo $row->Pincode; ?></h6>
