                                            ...
                                            ?>
                                                    ...
                                                    <td>
                                                        <form id="frm<?php echo $id; ?>" method="POST">
                                                            ...
                                                            <input type="number" class="form-control" name="qty" value="<?php echo $row->Quantity; ?>" onchange="updcart(<?php echo $id; ?>)" onkeyup="updcart(<?php echo $id; ?>)" min="1" max="4" style="width: 60px;">
                                                        </form>
                                                        <h5></h5>
                                                    </td>
                                                    <td>
