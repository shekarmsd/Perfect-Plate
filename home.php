            ...
            <div class="main-header header-sticky">
                <div class="container-fluid">
                    <div class="menu-wrapper">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="home.php" style="font-size: x-large;"><span style="color: black; ">Perfect</span>&nbsp;<span style="color: green;">Plate</span></a>
                        </div>
                        <!-- Main-menu -->
                        ...
                        <div class="header-right">
                            <ul>
                                <li><a href="cart.html" title="Cart"><span class="flaticon-shopping-cart"></span></a> </li>
                                <li> <a href="#" title="View Profile"><span class="flaticon-user">&nbsp; <?php echo($name); ?></span></a></li>
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                                <div class="hero__caption">
                                    ...
                                    <div class="hero__btn" data-animation="fadeInLeft" data-delay=".8s" data-duration="2000ms">
                                        <a href="industries.html" class="btn hero-btn">Order Now</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 d-none d-sm-block">
                                <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                    <img src="https://images.pexels.com/photos/256318/pexels-photo-256318.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="" class=" heartbeat">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        try {
                            ...
                            foreach ($rows as $row) {
                                ...
                                echo  '<div class="product-caption">';
                                        ...
                                        echo "<h4><span>&#x20B9; ". $row->price ."/-</span></h4>";
                                        echo '<div class="hero__btn" data-animation="fadeInLeft" data-delay=".8s" data-duration="2000ms">';
                                                echo '<a href="industries.html" class="btn hero-btn">Add to Cart</a>';
                                        echo '</div>';
                                    echo '</div>';
                                echo '</div>';
                                echo '</div>';
       ...
       <!-- <section class="new-product-area section-padding30">
        ...
        <div class="popular-items section-padding30">
            <div class="container">
                ...
                <div class="hero__btn" data-animation="fadeInLeft" data-delay=".8s" data-duration="2000ms" align="center">
