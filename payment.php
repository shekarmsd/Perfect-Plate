        ...
        <div id="Checkout" class="inline">
            ...
            <form method="POST" action="">
                ...
                <div class="expiry-date-group form-group">
                    ...
                    <input id="ExpiryDate" name="ExpiryDate" class="form-control" type="month" placeholder="MM / YY" min="2020-12" value="2020-12"></input>
                </div>
                <div class="security-code-group form-group">
                    <label for="SecurityCode">CVV</label>
                    <div class="input-container">
                        <input id="SecurityCode" name="SecurityCode" class="form-control" type="password"></input>
